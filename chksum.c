...
{                                           \
  ...
  return(i);                                \
                                            ...
                                            \
int cipher ## _add(void *state, int nbytes, const char *data)   { return(CIPHER ## _Update((CIPHER ## _CTX *)state, data, nbytes)); } \
                                                              \
...
int blank_add(void *state, int type, const char *data) { return(0); }
